...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "growl",
        ...
        defaults = {
            ...
            onHidden: null,
            icon_type: 'class',
            template: '<div data-growl="container" class="alert floating" role="alert" style="min-width: 750px"> ' +
            '<i data-growl="icon" class="fa"></i> ' +
            '<span data-growl="title"></span> ' +
            '<span data-growl="message"></span> ' +
            '<button type="button" class="close growl" data-growl="dismiss"> ' +
